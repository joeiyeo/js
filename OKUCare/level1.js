class level1 extends Phaser.Scene {
  ...
  create() {
    ...
    this.deafNPC.body.setSize(this.deafNPC.width * 0.2, this.deafNPC.height * 0.2);
    ...
    this.physics.add.overlap(this.player, [this.collectItem, this.collectItem], globalCollectItem, null, this);
